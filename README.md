...
This is just the server and is designed to just be ran somewhere. Once you got the server running, using the client (https://github.com/mrd875/GroupwareToolkitClient) to start using the project.
